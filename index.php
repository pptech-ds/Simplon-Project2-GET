...
<body>
    ...
    <div class="container">
        ...
        ?>
                    ...
                    <a href="index.php?step=3&point=<?= $_GET['point'] +
                        2 ?>" role="button" class="btn btn-success">oui</a> <!-- rapporte 2 point -->
                    <a href="index.php?step=3&point=<?= $_GET[
                        'point'
        ...
        ?>
                    ...
                    <a href="index.php?step=q3oui&point=<?= $_GET['point'] +
                        1 ?>" role="button" class="btn btn-success">oui</a> <!-- rapporte 1 point -->
                    <a href="index.php?step=q3non&point=<?= $_GET['point'] -
                        1 ?>" role="button" class="btn btn-danger">non</a> <!-- rapporte -1 point -->
        <?php
            } elseif ($_GET['step'] == 'q3oui') {
